...
%% Figure 2D top: Avg corrmat for each brain region

hfig = figure('Position',[300 300 1000 400]);
hfig.Name = 'Figure 2D top: avg corrmats by brain region (MEC, RSC, V1)';
...
%% Figure 2D bottom: Avg corrmat for each brain region

hfig = figure('Position',[300 300 1000 150]);
hfig.Name = 'Figure 2D bottom: avg corr to baseline by brain region (MEC, RSC, V1)';
